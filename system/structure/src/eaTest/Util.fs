namespace EA.Test
  module Util=
    ...
    let newMain (argv:string[]) (compilerCancelationToken:System.Threading.CancellationTokenSource) (manualResetEvent:System.Threading.ManualResetEventSlim) =
        ...
        try
            let ret=0 //loadEAConfigFromCommandLine argv |> inputStuff  |> doStuff |> outputStuff
        ...
        with
            | :? UserNeedsHelp as hex ->
                ...
                Logary.Message.eventFormat (Verbose, "newMain Exit User Need Help")|> Logger.logSimple moduleLogger
                0
            | ex ->
                ...
                if ex.InnerException = null
                    then
                        Logary.Message.eventFormat (Verbose, "newMain Exit System Exception")|> Logger.logSimple moduleLogger
                        1
                    else
