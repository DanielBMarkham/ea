    ...
    let tests =
      testList "samples" [
        ...
        testCase "when true is not (should fail)" <| fun _ ->
          ...
          // logger.error(
          //   Message.eventX "Has prop {property}"
          //   >> Message.setField "property" "moo cow")
          //Expect.equal "dog" "cat" "I am Voltron, lord of snails"

        // testCase "I am Voltron" <| fun _ ->
        //   let subject = false
        //   Expect.isTrue subject "I am not Voltron"
